...
describe GameHandler do
  ...
  it 'can list all games' do
    mock_game = double('Game', title: 'The Legend of Zelda', author: 'Shigeru Miyamoto', multiplayer: true, last_played_at: Date.today)
  ...
  it 'can list all authors' do
    mock_game = double('Game', title: 'The Legend of Zelda', author: 'Shigeru Miyamoto', multiplayer: true, last_played_at: Date.today)
    mock_game2 = double('Game', title: 'Super Mario Bros.', author: 'Shigeru Miyamoto', multiplayer: false, last_played_at: Date.today)
